import { ICarouselItemCarreras } from './../carousel-carreras/icarousel-item.metadata';
export const CAROUSEL_DATA_ITEMS_CARRERA: ICarouselItemCarreras[]=[
  {
    id:1,
    title:{
      first:'Ingeniería en',
      second:'Sistemas Computacionales'
    },
    ...
    id:7,
    title:{
      first:'Licenciatura en',
      second:'Contador Público'
    },
    subtitle: 'Esto es una gran descripción',
